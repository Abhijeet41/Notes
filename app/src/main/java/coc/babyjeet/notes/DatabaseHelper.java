...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Note> getAllNotes() //for showing on listview
    {
    ...
    public int updateNote(Note note)
    {
        ...
        contentValues.put(Note.COLUMN_NOTE,note.getId());

        return db.update(Note.TABLE_NAME, contentValues, Note.COLUMN_ID + "=?",
